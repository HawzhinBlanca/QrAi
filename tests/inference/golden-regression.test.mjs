...
import { alignWords, calculateConfidence, normalizeArabic } from "../../server/src/inference/alignment.mjs";
...
const goldenEvals = JSON.parse(
  readFileSync(join(__dirname, "..", "..", "server", "src", "inference", "fixtures", "golden-evals.json"), "utf8"),
);
