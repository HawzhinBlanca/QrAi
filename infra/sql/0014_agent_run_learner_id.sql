...
-- id (and, if the agent ever includes more identifying detail in `goal`/`trace`, potentially
-- more) sitting in every Practice Plan Recommender run ever generated for them, indefinitely.
--
