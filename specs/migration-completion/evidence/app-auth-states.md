...
**2026-08-02.** `AUD1` gave the app an out-of-band token (`QRAI_BEARER_TOKEN` → platform secure
storage). This is what a learner sees in each state, driven in a browser against `platform-api` on
