...
- `infra/migrations/0003_tenant_rls.sql`, `0009_learner_progress_rls.sql`, and `0012_superuser_only_rls_bypass.sql` define tenant RLS policies and restricted bypass behavior.
