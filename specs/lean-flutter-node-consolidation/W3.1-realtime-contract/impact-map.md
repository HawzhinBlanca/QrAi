...
| `server/src/lib/ticket.mjs` ticket comment/path only | recitation ticket route, gateway/E2E/smoke/parity tests, future realtime protocol | preserve crypto and wire bytes; point at final fixture authority | Node vectors + API parity + gateway smoke |
